(function(e) {
  ...
  var m = function() {
    }, j = e.getOptions(), g = e.each, n = e.extend, o = e.wrap, h = e.Chart, i = e.seriesTypes, k = i.pie, l = i.column,
  ...
  j.drilldown = {
    ...
    activeDataLabelStyle: {
      cursor: "pointer",
      color: "#039", fontWeight: "bold", textDecoration: "underline"
    },
  ...
  k.prototype.animateDrilldown = function(b) {
    var a = this.chart.drilldownLevels[this.chart.drilldownLevels.length - 1],
      c = this.chart.options.drilldown.animation, d = a.shapeArgs, f = d.start, s = (d.end - f) / this.points.length,
  ...
  l.prototype.animateDrillupFrom = k.prototype.animateDrillupFrom = function(b) {
    ...
    g(this.points, function(d) {
      ...
      delete d.graphic;
      f.animate(b.shapeArgs, e.merge(a, {
        step: function(a, c) {
